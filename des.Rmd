...
#accuracy side
{
data.1$LR.accuracy_side <- ifelse(( (data.1$LR.percepton %in% c(0:10)[1:round(length(c(0:10))/2)] & data.1$LR.truth %in% c(0:10)[1:round(length(c(0:10))/2)])
                                    |(data.1$LR.percepton %in% c(0:10)[round(length(c(0:10))/2):11] & data.1$LR.truth %in%
...
#accuracy precise
{
data.1$LR.accuracy_precise <- ifelse(data.1$LR.percepton == data.1$LR.truth,1,0)
...
#plotting data
df <- rbind(
  data.1[which(data.1$Relationship=="Confidant"), c(64, which(grepl( "accuracy_side", names(data.1))))],
  data.1[which(data.1$Relationship=="Study partner"), c(64, which(grepl( "accuracy_side", names(data.1))))],
  data.1[which(data.1$Relationship=="Best Friend"), c(64, which(grepl( "accuracy_side", names(data.1))))],
  data.1[which(data.1$Relationship=="Sports partner"), c(64, which(grepl( "accuracy_side", names(data.1))))]
)
...
#plotting data
df <- rbind(
  data.1[which(data.1$Relationship=="Confidant"), c(64, which(grepl( "accuracy_precise", names(data.1))))],
  data.1[which(data.1$Relationship=="Study partner"), c(64, which(grepl( "accuracy_precise", names(data.1))))],
  data.1[which(data.1$Relationship=="Best Friend"), c(64, which(grepl( "accuracy_precise", names(data.1))))],
  data.1[which(data.1$Relationship=="Sports partner"), c(64, which(grepl( "accuracy_precise", names(data.1))))]
)
...
#subset accuracy measures, relationship type, embeddedness and respnr
#names(df)
df <- df[,c(1,16,64,which(grepl("accuracy_side", names(df))))]
...
#subset accuracy measures, relationship type, embeddedness and respnr
#names(df)
df <- df[,c(1,16,64,which(grepl("accuracy_precise", names(df))))]
